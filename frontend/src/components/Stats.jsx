...
export default function Stats({ stats }) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
      ...
      <div className="bg-white rounded-xl border-l-4 border-green-500 p-4 shadow-sm col-span-2 sm:col-span-3 lg:col-span-1">
        <p className="text-xs text-gray-500 font-medium uppercase tracking-wide">Ingresos hoy</p>
        <p className="text-lg font-bold text-green-600 mt-0.5">{fmtCOP(stats.ingresos_hoy)}</p>
      </div>
    </div>
  );
}
